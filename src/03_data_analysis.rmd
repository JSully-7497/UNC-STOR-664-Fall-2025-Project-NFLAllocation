...
Details about data pre-processing and explanatory data analysis are contained in the part 1 report. In this pdf we only include data analyses and discussion. 
...
Throughout this question, we assume that the capital strategy of each team does not change during the period. Therefore, each year represents an i.i.d.\ sample from a certain distribution. 
